...
var CorePlugin = require('./../plugins/corePlugin').CorePlugin, util = require('util'), utils = require('./../utils/utils.js');
 ...
 */
var DevicePlugin = exports.DevicePlugin = function (params) {
